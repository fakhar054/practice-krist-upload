        ...
        <div className="container max-w-xl">
          ...
          >
            <div className="vstack items-center gap-4 mb-4 sm:mb-6 lg:mb-8 max-w-850px mx-auto text-center">
              ...
              Nel 2014, l'idea di Ma&Se è nata per offrire agli albergatori uno strumento in grado 
              di semplificare la gestione operativa e migliorare il rapporto con i clienti. Oggi, Ma&Se 
              consente ai team di ottimizzare il proprio tempo, creando facilmente documenti personalizzati in pochi minuti e costruendo 
              relazioni significative con gli ospiti, trasformando ogni interazione in un'opportunità per crescere e fidelizzare.
              </p>
            </div>
