export const panelData = [
  {
    id: 1,
    lightIcon: "/assets/images/template/icon-diamond.sv",
...
export const features4 = [
  {
    icon: "unicon-document",
    title: "Gestione Dinamica delle Tariffe",
    description:
      "Ottimizza i prezzi in base a domanda, eventi e stagionalità per massimizzare i ricavi.",
  },
  {
    icon: "unicon-model",
    title: "Integrazione con Canali OTA Online",
    description:
      "Connettiti a piattaforme come Booking.com ed Expedia, aggiornando disponibilità e prezzi in tempo reale.",
  },
  {
    icon: "unicon-task-approved",
    title: "Automazione delle Prenotazioni",
    description:
      "Gestisci prenotazioni da ogni canale con sincronizzazione immediata e prevenzione di overbooking.",
  },
  {
    icon: "unicon-touch-interaction",
    title: "Analisi e Reportistica Avanzata",
    description:
      "Monitora le performance con report dettagliati per prendere decisioni informate.",
  },
  {
    icon: "unicon-sub-volume",
    title: "Check-in e Check-out Digitale",
    description:
      "Velocizza il processo di registrazione con opzioni online e chiavi digitali.",
  },
  {
    icon: "unicon-currency",
    title: "Gestione Operativa delle Camere",
    description:
      "Organizza pulizie, manutenzione e richieste ospiti in modo centralizzato e semplice.",
  },
];
